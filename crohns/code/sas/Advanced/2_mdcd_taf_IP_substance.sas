/********************************************************************
* Job Name: 2_mdcd_taf_IP_substance.sas
...
%let  ds_all_prefix      = ;
%let  ds_all_ip          = &shlib..&proj_ds_pfx.substance_ip_2014_19;
...
%macro ibdyear(serveryear=, ibdyear=);
		data    &ibdyear;
		          set &serveryear 
						(keep= &pat_idb  &clm_beg_dt &clm_end_dt
								&diag_pfx.:  );
		          where &diag_pfx.1 in ( &main_diag_criteria ) or
		                &diag_pfx.2 in ( &main_diag_criteria ) or
		                &diag_pfx.3 in ( &main_diag_criteria ) or
		                &diag_pfx.4 in ( &main_diag_criteria ) or
		                &diag_pfx.5 in ( &main_diag_criteria ) or
		                &diag_pfx.6 in ( &main_diag_criteria ) or
		                &diag_pfx.7 in ( &main_diag_criteria ) or
		                &diag_pfx.8 in ( &main_diag_criteria ) or
		                &diag_pfx.9 in ( &main_diag_criteria ) or
						&diag_pfx.10 in ( &main_diag_criteria ) or
						&diag_pfx.11 in ( &main_diag_criteria ) or
						&diag_pfx.12 in ( &main_diag_criteria ) or
				substr(&diag_pfx.1,1,3) in ( &main_diag3_criteria ) or
                substr(&diag_pfx.2,1,3) in ( &main_diag3_criteria ) or
                substr(&diag_pfx.3,1,3) in ( &main_diag3_criteria ) or
                substr(&diag_pfx.4,1,3) in ( &main_diag3_criteria ) or
                substr(&diag_pfx.5,1,3) in ( &main_diag3_criteria ) or
                substr(&diag_pfx.6,1,3) in ( &main_diag3_criteria ) or
                substr(&diag_pfx.7,1,3) in ( &main_diag3_criteria ) or
                substr(&diag_pfx.8,1,3) in ( &main_diag3_criteria ) or
                substr(&diag_pfx.9,1,3) in ( &main_diag3_criteria ) or
				substr(&diag_pfx.10,1,3) in ( &main_diag3_criteria ) or
				substr(&diag_pfx.11,1,3) in ( &main_diag3_criteria ) or
				substr(&diag_pfx.12,1,3) in ( &main_diag3_criteria ) or
				substr(&diag_pfx.1,1,3) in ( &main_diag4_criteria ) or
                substr(&diag_pfx.2,1,3) in ( &main_diag4_criteria ) or
                substr(&diag_pfx.3,1,3) in ( &main_diag4_criteria ) or
                substr(&diag_pfx.4,1,3) in ( &main_diag4_criteria ) or
                substr(&diag_pfx.5,1,3) in ( &main_diag4_criteria ) or
                substr(&diag_pfx.6,1,3) in ( &main_diag4_criteria ) or
                substr(&diag_pfx.7,1,3) in ( &main_diag4_criteria ) or
                substr(&diag_pfx.8,1,3) in ( &main_diag4_criteria ) or
                substr(&diag_pfx.9,1,3) in ( &main_diag4_criteria ) or
				substr(&diag_pfx.10,1,3) in ( &main_diag4_criteria ) or
				substr(&diag_pfx.11,1,3) in ( &main_diag4_criteria ) or
				substr(&diag_pfx.12,1,3) in ( &main_diag4_criteria ) ;
...
*shu172sl.taf_substance_ip_2014_19;
