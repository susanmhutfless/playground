/********************************************************************
* Job Name: 2_mdcd_taf_ot_fistula.sas
* Job Desc: Identify fistula use in other_services (not IBD specific)
...
%let  shlib              = shu172sl          ;
    ...
    %let    temp_ds_pfx = tmp_fist_;  /*** prefix to identify temp data
										...
										/*fist is for fistula other_services*/
...
%global final_sub_ds;
%let    final_sub_ds = &shlib..&proj_ds_pfx.fistula_ot_2014_2019;
...
%mend;
%let NN=14;
%ibdyear(serveryear=tafr&NN..other_services_header_01, ibdyear=fist_ot_20&NN._01);
%ibdyear(serveryear=tafr&NN..other_services_header_02, ibdyear=fist_ot_20&NN._02);
%ibdyear(serveryear=tafr&NN..other_services_header_03, ibdyear=fist_ot_20&NN._03);
%ibdyear(serveryear=tafr&NN..other_services_header_04, ibdyear=fist_ot_20&NN._04);
%ibdyear(serveryear=tafr&NN..other_services_header_05, ibdyear=fist_ot_20&NN._05);
%ibdyear(serveryear=tafr&NN..other_services_header_06, ibdyear=fist_ot_20&NN._06);
%ibdyear(serveryear=tafr&NN..other_services_header_07, ibdyear=fist_ot_20&NN._07);
%ibdyear(serveryear=tafr&NN..other_services_header_08, ibdyear=fist_ot_20&NN._08);
%ibdyear(serveryear=tafr&NN..other_services_header_09, ibdyear=fist_ot_20&NN._09);
%ibdyear(serveryear=tafr&NN..other_services_header_10, ibdyear=fist_ot_20&NN._10);
%ibdyear(serveryear=tafr&NN..other_services_header_11, ibdyear=fist_ot_20&NN._11);
%ibdyear(serveryear=tafr&NN..other_services_header_12, ibdyear=fist_ot_20&NN._12);
data fist_ot_20&NN.;
set fist_ot_20&NN._01 - fist_ot_20&NN._12;
yr_num=20&NN.;
run;
%let NN=15;
%ibdyear(serveryear=tafr&NN..other_services_header_01, ibdyear=fist_ot_20&NN._01);
...
proc sort data= ds_fist_op  nodupkey out = &final_sub_ds;
by &pat_idb fistula_dt fistula_intest_dt fistula_perianal_dt fistula_rectvag_dt;
run;
*shu172sl.taf_fistula_ot_2014_19;
