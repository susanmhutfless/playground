/********************************************************************
* Job Name: 2_mdcd_max_IP_substance.sas
...
%let  shlib              = shu172sl          ;
    ...
    %global temp_ds_pfx;
    %let    temp_ds_pfx = tmp_sip_;  /*** prefix to identify temp data
                                          leave the trailing underscore ***/
										/*sip is for substance inpatient*/
...
%global final_sub_ds;
%let    final_sub_ds = &shlib..&proj_ds_pfx.substance_ip_2010_2015;
...
/*   identify substance use based on DX code in inpatient setting                   */
...
%macro create_dsk(view_lib       = ,
     ...
     data        &view_lib..&prefix.data_sub_&ctype._&year.    /
          view = &view_lib..&prefix.data_sub_&ctype._&year.    ;
...
data &final_sub_ds;
set
&view_lib..&def_proj_src_ds_prefix.data_sub_ip_2010    (in=a)
&view_lib..&def_proj_src_ds_prefix.data_sub_ip_2011    (in=b)
&view_lib..&def_proj_src_ds_prefix.data_sub_ip_2012    (in=c)
&view_lib..&def_proj_src_ds_prefix.data_sub_ip_2013    (in=d)
&view_lib..&def_proj_src_ds_prefix.data_sub_ip_2014    (in=e)
&view_lib..&def_proj_src_ds_prefix.data_sub_ip_2015    (in=f)
;
run;
