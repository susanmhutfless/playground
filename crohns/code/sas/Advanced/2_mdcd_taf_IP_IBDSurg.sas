/********************************************************************
* Job Name: 2_mdcd_taf_IP_IBDSurg.sas
* Job Desc: Identify all IBD-related surgical procedures (inpatient setting only)
...
%global final_sub_ds;
%let    final_sub_ds = &shlib..&proj_ds_pfx.ibdsurg_ip_2014_2019;
...
%let    flag_ibd_surg          = ibd_surg_surg  ;
...
%mend;
%let NN=14;
%ibdyear(serveryear=tafr&NN..inpatient_header_01, ibdyear=ibd_surg_20&NN._01);
%ibdyear(serveryear=tafr&NN..inpatient_header_02, ibdyear=ibd_surg_20&NN._02);
%ibdyear(serveryear=tafr&NN..inpatient_header_03, ibdyear=ibd_surg_20&NN._03);
%ibdyear(serveryear=tafr&NN..inpatient_header_04, ibdyear=ibd_surg_20&NN._04);
%ibdyear(serveryear=tafr&NN..inpatient_header_05, ibdyear=ibd_surg_20&NN._05);
%ibdyear(serveryear=tafr&NN..inpatient_header_06, ibdyear=ibd_surg_20&NN._06);
%ibdyear(serveryear=tafr&NN..inpatient_header_07, ibdyear=ibd_surg_20&NN._07);
%ibdyear(serveryear=tafr&NN..inpatient_header_08, ibdyear=ibd_surg_20&NN._08);
%ibdyear(serveryear=tafr&NN..inpatient_header_09, ibdyear=ibd_surg_20&NN._09);
%ibdyear(serveryear=tafr&NN..inpatient_header_10, ibdyear=ibd_surg_20&NN._10);
%ibdyear(serveryear=tafr&NN..inpatient_header_11, ibdyear=ibd_surg_20&NN._11);
%ibdyear(serveryear=tafr&NN..inpatient_header_12, ibdyear=ibd_surg_20&NN._12);
data ibd_surg_20&NN.;
...
out=&shlib..&proj_ds_pfx.ibdsurg_ip_2014_2019;
...
%counts(in=&shlib..&proj_ds_pfx.ibdsurg_ip_2010_2015,
		out=ibd_hosp_ip_cnt , 
